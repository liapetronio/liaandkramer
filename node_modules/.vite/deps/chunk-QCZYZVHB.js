          ...
          ret.catch(
            (reason) => {
              ...
              return (
                ...
                ((_a = loader._.options.errors) == null ? void 0 : _a.some((Err) => reason instanceof Err)) || (Array.isArray(errors) ? errors.some((Err) => reason instanceof Err) : errors(reason)) ? void 0 : Promise.reject(reason)
              );
            }
          )
        );
...
//# sourceMappingURL=chunk-QCZYZVHB.js.map
